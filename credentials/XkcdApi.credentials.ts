...
export class XkcdApi implements ICredentialType {
	name = 'N8nDevXkcdApi';

	displayName = 'xkcd API';

	icon: Icon = { light: 'file:../nodes/Xkcd/xkcd.png', dark: 'file:../nodes/Xkcd/xkcd.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			placeholder: 'http://xkcd.com/',
			description: 'The base URL of your xkcd API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
